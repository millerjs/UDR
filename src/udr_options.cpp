...
void usage() {
    fprintf(stderr, "usage: udr [-n aes-128 | aes-192 | aes-256 | bf | des-ede3] [-m number of crypto threads] [-v] [-a starting port number] [-b ending port number] [-c remote udr location] rsync [rsync options]\n");
    exit(1);
}
